...
The canonical npm package is live at
<https://www.npmjs.com/package/@autoworks-ai/autovault>. Use npm when you want
the packaged CLI/library directly:
...
Homebrew is also available through the AutoWorks tap:
...
Release Please publishes future package versions through npm trusted publishing
...
1. **Create the service from the image** — point at `ghcr.io/autoworks-ai/autovault:v0.3.0`
...
| Field | Value |
|---|---|
| Image source | `ghcr.io/autoworks-ai/autovault:v0.3.0` (pin a tag for reproducibility, or `:latest` for auto-update) |
